...
ls = [35,10,20,40,60,10,20]
s = len(set(ls))
print("Unique elements are",s)
...
ls = [10,20,30,40,50]
ls2 = [60,70,80,30,40]
common_element = set(ls).intersection(set(ls2))
if common_element:
